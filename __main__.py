...
plot = plt.plot(matrix.array[:,:5]), plt.xlabel("Loaded data [first 5 plots]")
plt.show(plot)
...
plot = plt.plot(matrix.array[:,:5]), plt.xlabel("Exponential Decay [first 5 plots]")
plt.show(plot)

matrix.generate.inverseWishart(50, 100, 0.3)
print(matrix.array)

plot = plt.plot(matrix.array[:,:5]), plt.xlabel("Inverse Wishart [first 5 plots]")
plt.show(plot)
